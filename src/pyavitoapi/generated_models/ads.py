...
class CampaignStatus(RootModel[Literal['draft', 'in_moderation', 'moderation_failed', 'partial_moderation', 'active', 'will_launch_soon', 'partially_active', 'will_stop_soon', 'pausing', 'paused', 'unpausing', 'stopped', 'finished', 'archived']]):
    pass
...
class Campaign(_BaseModel):
    ...
    budget: int = None
    budget_kopeks: int = Field(default=None, alias='budgetKopeks')
...
class StatsData(_BaseModel):
    ...
    spend_bonus_kopeks: int = Field(default=None, alias='spendBonusKopeks')
    spend_kopeks: int = Field(default=None, alias='spendKopeks')
...
class Creative(_BaseModel):
    ...
    id: int = None
    landing_id: int | None = Field(default=None, alias='landingID')
...
class FrequencyRule(_BaseModel):
    count: int
...
class Group(_BaseModel):
    ...
    price_kopeks: int = Field(default=None, alias='priceKopeks')
